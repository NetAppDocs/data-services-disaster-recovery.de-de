...
summary: Bevor Sie NetApp Disaster Recovery verwenden, müssen Sie dem NetApp Console lokale und in der Cloud gehostete Speicherinstanzen hinzufügen. 
---
= Lokale Arrays können der NetApp Console für Amazon EVS mit NetApp Disaster Recovery hinzugefügt werden.
:allow-uri-read: 
...
. Wählen Sie auf der Seite „NetApp Console “ die Option „System hinzufügen“ aus.
+
