...
[role="lead"]
Die erforderlichen ONTAP Berechtigungen konfigurieren, damit NetApp Disaster Recovery ordnungsgemäß funktioniert.
...
Für die Notfallwiederherstellung sind folgende ONTAP Berechtigungen erforderlich:
...
Um Berechtigungen in ONTAP hinzuzufügen, eine Rolle mit den erforderlichen Berechtigungen erstellen und diese einem Benutzer zuweisen. Diese Aufgabe kann in ONTAP mit System Manager oder der ONTAP CLI abgeschlossen werden.
