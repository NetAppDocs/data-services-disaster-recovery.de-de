...
Sie können jederzeit sofort einen Snapshot des Replikationsplans erstellen.  Dieser Snapshot ist in den Überlegungen zur NetApp Notfallwiederherstellung enthalten, die durch die Snapshot-Aufbewahrungsanzahl des Replikationsplans festgelegt werden.
...
+
.. Wöchentlich: Wählen Sie den Wochentag aus
