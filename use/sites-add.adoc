...
[role="lead"]
Bevor Sie einen Notfallwiederherstellungsplan erstellen können, müssen Sie einem Standort einen primären vCenter-Server und in der NetApp Console einen vCenter-Zielstandort für die Notfallwiederherstellung hinzufügen.


TIP: Stellen Sie sicher, dass sowohl das Quell- als auch das Ziel-vCenter denselben NetApp Console verwenden.
...
. Wählen Sie auf der Seite „Sites“ die Site aus und wählen Sie *vCenter hinzufügen*.
