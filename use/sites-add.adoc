...
[role="lead"]
Bevor Sie einen Notfallwiederherstellungsplan erstellen, fügen Sie die zu schützenden Standorte in NetApp Disaster Recovery hinzu. Ein Standort ist eine Sammlung von vCenter Servern oder Kubernetes-Clustern, entweder lokal oder in der Cloud. Sowohl der Produktionsstandort als auch der Notfallwiederherstellungsstandort sollten hinzugefügt werden, damit Disaster Recovery die für die Wiederherstellung verwendeten Ressourcen koordinieren kann.
...
--
. Wählen Sie in der Seitenleiste unter „Disaster Recovery“ **Sites** aus.
. Stellen Sie im Dropdown-Menü „Workload“ den Filter auf *Kubernetes* ein.
+
image::site-type-toggle.png[Screenshot der Umschaltung des Website-Typs]
...
. Im Einstellungsfenster bearbeiten Sie die Felder nach Bedarf.
. Um den Ermittlungszeitplan anzupassen, aktivieren Sie das Kontrollkästchen *Geplante Ermittlung aktivieren*. Wählen Sie das Datum aus, an dem die Ermittlung beginnen soll, sowie das Intervall der Ermittlung in Stunden und Minuten.
