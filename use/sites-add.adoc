...
[role="lead"]
Bevor ein Notfallwiederherstellungsplan erstellt wird, werden die zu schützenden Standorte in NetApp Disaster Recovery hinzugefügt. Ein Standort ist eine Sammlung von vCenter Servern oder Kubernetes-Clustern, entweder lokal oder in der Cloud. Sowohl der Produktionsstandort als auch der Notfallwiederherstellungsstandort werden hinzugefügt.
