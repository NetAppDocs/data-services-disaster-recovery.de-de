...
+
Wenn Sie NetApp Disaster recovery zum ersten Mal verwenden, müssen Sie vCenter-Informationen hinzufügen. Wenn Sie bereits vCenter-Informationen hinzugefügt haben, wird das Dashboard angezeigt.
