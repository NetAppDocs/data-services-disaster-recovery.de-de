...
IMPORTANT: Falls der Replikationsplan einen leeren Datenspeicher enthält, müssen Sie zuerst den leeren Datenspeicher aus dem Plan entfernen oder die Option **Force failover** verwenden, die die leeren Datenspeicher überspringt.
