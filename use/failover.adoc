...
Während eines Failover-Tests erstellt Disaster Recovery vorübergehend virtuelle Maschinen. Disaster Recovery ordnet einen temporären Datenspeicher, der das FlexClone Volume sichert, den ESXi-Hosts zu.
