...
summary: Mit Ressourcengruppen können Sie eine Reihe abhängiger Ressourcen in logischen Gruppen organisieren, die Ihren Anforderungen entsprechen. 
---
...
. Klassifizieren Sie die *Ressourcentypen*. Standardmäßig ist die Auswahl „Alle einschließen“ gewählt, was mehrere Ressourcentypen bedeutet.
