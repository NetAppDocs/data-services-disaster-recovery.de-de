...
[role="lead"]
Nachdem Sie vCenter-Standorte hinzugefügt haben, können Sie Ressourcengruppen erstellen, um Gruppen von VMs oder Datenspeichern als eine Einheit zusammenzufassen. Ressourcengruppen ermöglichen es Ihnen, eine Reihe von abhängigen VMs in logische Gruppen zu organisieren, die Ihren Anforderungen entsprechen. Beispielsweise könnten Sie VMs gruppieren, die mit einer Anwendung verbunden sind, oder Anwendungen gruppieren, die ähnliche Ebenen haben. Ein weiteres Beispiel: Gruppen könnten verzögerte Startreihenfolgen enthalten, die bei der Wiederherstellung ausgeführt werden können.
...
Mit Ressourcengruppen können Sie VMs oder Datastores zu einer einzigen Einheit zusammenfassen.
