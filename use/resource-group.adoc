...
* ONTAP -API: `cg_start` .  Stellt alle Volumes still, damit Snapshots erstellt werden können, und initiiert Snapshots auf Volume-Ebene aller Ressourcengruppen-Volumes.
