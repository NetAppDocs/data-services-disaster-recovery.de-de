...
[role="lead"]
Nachdem Sie Ressourcen zu Standorten hinzugefügt haben, können Ressourcengruppen erstellt werden, um VMs, Datenspeicher oder Kubernetes-Cluster als Einheit zu organisieren. Ressourcengruppen ermöglichen die Organisation abhängiger Ressourcen in logischen Gruppen, die den jeweiligen Anforderungen entsprechen. So können beispielsweise VMs für eine Anwendung oder Anwendungen mit ähnlichen Ebenen gruppiert werden. Ressourcengruppen können auch verzögerte Startreihenfolgen enthalten, die während der Wiederherstellung ausgeführt werden, damit die Ressourcen in der richtigen Reihenfolge starten.
