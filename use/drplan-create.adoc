...
*Erforderliche NetApp Console-Rolle* Super admin, Disaster recovery admin, Disaster recovery failover admin oder Disaster recovery application admin Rolle.
