...
[role="lead"]
Nachdem Sie Ressourcen und Standorte hinzugefügt haben, sind Sie bereit, einen  zu erstellen. Replikationspläne verwalten den Datenschutz. Die Erstellung der Replikation umfasst die Festlegung der Quell- und Zielstandorte, die Auswahl der Ressourcengruppen und die Bestimmung, wie Anwendungen wiederhergestellt und eingeschaltet werden sollen. Beispielsweise können Sie virtuelle Maschinen (VMs) gruppieren, die einer Anwendung zugeordnet sind, oder Anwendungen, die ähnliche Ebenen haben.
