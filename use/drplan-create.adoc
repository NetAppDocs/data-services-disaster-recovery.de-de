...
. Wählen Sie unter *Quelle* den vCenter oder Kubernetes-Cluster aus, der als Quelle verwendet werden soll.
...
** Wenn die Ressourcengruppe und die zugehörigen Ressourcen auf den Notfallwiederherstellungsstandort verschoben werden müssen, sind nach dem Failover-Prozess keine ungeschützten Ressourcen mehr am Quellstandort vorhanden, was zum Ausfall ungeschützter VMs am Quellstandort führt. Außerdem wird NetApp Disaster Recovery diese ungeschützten VMs am Failover-vCenter-Standort nicht starten.
