...
+
Bei der Einstellung der Snapshot-Frequenz beträgt das Minimum fünf Minuten.
...
.. Basierend auf der Anbieterauswahl füllt Disaster Recovery die vorhandenen konfigurierten Cloud-Abonnements aus. Wählen Sie das *Abonnement*, die *Ressourcengruppe* und das *Speicherkonto* für den Cloud-Anbieter aus.
.. Wählen Sie **Hinzufügen**.
+
...
NOTE: Für Kubernetes ist dies der letzte Schritt zum Erstellen einer Replikation. Für vCenters fahren Sie mit <<Abschnitt Compute-Ressourcen>> fort.
