...
[role="lead"]
Die Notfallwiederherstellung in der Cloud ist eine resiliente und kostengünstige Methode, um Workloads vor Standortausfällen und Datenbeschädigung zu schützen. Mit NetApp Disaster Recovery können Sie Ihre lokalen VMware-VM- oder Datenspeicher-Workloads, die auf ONTAP-Speicher laufen, in ein VMware-Software-Defined Data Center in einer Public Cloud mithilfe von NetApp Cloud-Speicher oder in eine andere lokale VMware-Umgebung mit ONTAP-Speicher als Disaster-Recovery-Standort replizieren. Sie können Disaster Recovery auch nutzen, um VM-Workloads von einem Standort zu einem anderen zu migrieren.

NetApp Disaster Recovery ist ein Cloud-basiert Disaster-Recovery-Dienst, der Disaster-Recovery-Workflows automatisiert. Mit NetApp Disaster Recovery können Sie Ihre lokalen Kubernetes-Cluster, NFS-basierte Workloads und VMware vSphere Virtual Machine File System (VMFS)-Datenspeicher für iSCSI- und FC-basierte NetApp Speichersysteme auf eine der folgenden Arten schützen:
...
Disaster Recovery verwendet die folgenden Komponenten, um Disaster-Recovery-Workloads bereitzustellen:
