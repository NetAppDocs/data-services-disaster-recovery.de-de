...
+
** Wenn Sie noch keinen NetApp Console Agenten hinzugefügt haben, müssen Sie einen hinzufügen. Um den Agenten hinzuzufügen, siehe https://docs.netapp.com/us-en/console-setup-admin/concept-connectors.html["Erfahren Sie mehr über Konsolenagenten"^] Die
